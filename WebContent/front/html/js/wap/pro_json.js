    ...
    addFiltrateList: function (big, middle, small) {    //筛选列表输出函数
        ...
        if (l == 0) {       //筛选一级列表输出
            ...
            for (x in j) {
                ...
                sLi += '<dt data-id="' + j[x]["id"] + '" data-url="' + url + '">' + j[x]["name"] + (hasmore?'<a href="#">更多&nbsp;></a>':'') + '</dt><dd class="' + (hasmore?"more":"all") + '">';
            ...
            sList = '<div class="filter-con"><div class="filter-top" >筛选</div><dl class="filter-list">' + sLi + '</dl></div>';
        ...
        if (l == 1) {   //筛选二级列表输出
            ...
            if (typeof(j) == 'object') {
                ...
                sList = '<div class="filter-con"><div class="filter-top" ><a class="arrow-l" ></a>全部' + jn + '</div><dl class="filter-list">' + sLi + '</dl></div>';
                return sList;
            }
        }
        if (l == 2) {       //筛选三级列表输出

                ...
                <li class="header-icon dib">
                    ...
                    <div class="drop-down dropdown-profile">
                        <div class="dropdown-content-body">
                            <ul>
                                <li><a href="javascript:logout()"><i class="ti-power-off"></i> <span>退出系统</span></a></li>
                            </ul>
                        </div>
                    </div>
                </li>
                                ...
                                <div class="card-header">
                                    <div class="panel-heading bk-bg-white">
                                    	<div style="float:left;">
											<h6>
												<a type="button" class="btn btn-success m-b-10" href="goodspreSave">添加商品</a>
			                                    <a type="button" class="btn btn-warning m-b-10" href="goodslist">刷新</a>
											</h6>
										</div>
										<div class="panel-actions" style="float:right;width:430px;margin-top:10px;margin-right:15px;">
											<form name="myForm" method="post" action="goodslist">
	                                            ...
	                                            <tr>
													...
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="goodspreSave?goodsId=${goods.goods_id}">编辑</a>
														</div>
														<div style="float:left;">

				        	...
				        	if (goods_name == '') {
				        		...
				        		if (goods_price == '') {
				        			...
				        			if (goods_num == '') {
				        				...
				        				var goods_starttime = document.getElementById('goods_starttime').value;
				        				if (goods_starttime == '') {
				        					alert("抢购开始时间不能为空！");
								        	flag = false;
				        				} else {
				        					var goods_endtime = document.getElementById('goods_endtime').value;
				        					if (goods_endtime == '') {
				        						alert("抢购结束时间不能为空！");
									        	flag = false;
				        					} else {
                            ...
                            <div class="card alert">
                                ...
                                <div class="card-body">
                                    <div class="basic-form">
                                        <form class="form-horizontal form-bordered" method="post" action="goodslimittimesave" onsubmit="return formcheckForm();">
                                        	<input type="hidden" name="goodsId" value="${goodsId}">
                                        	<input type="hidden" name="goods_promote" value="2">
	                                        ...
	                                        <c:if test="${goods.goods_starttime == null}">
												<div class="form-group">
		                                             <label>开始时间</label>
		                                             <input type="datetime-local" value="2020-03-25T10:59:01" class="form-control" id="goods_starttime" name="goods_starttime" placeholder="请输入开始时间">
		                                        </div>
											</c:if>
											<c:if test="${goods.goods_starttime != null}">
												<div class="form-group">
		                                             <label>开始时间</label>
		                                             <input type="datetime-local" value="${goods.goods_starttime}" class="form-control" id="goods_starttime" name="goods_starttime" placeholder="请输入开始时间">
		                                        </div>
											</c:if>
	                                        
	                                        <c:if test="${goods.goods_endtime == null}">
												<div class="form-group">
		                                             <label>结束时间</label>
		                                             <input type="datetime-local" value="2020-03-25T11:59:01" class="form-control" id="goods_endtime" name="goods_endtime" placeholder="请输入结束时间">
		                                        </div>
											</c:if>
											<c:if test="${goods.goods_endtime != null}">
												<div class="form-group">
		                                             <label>结束时间</label>
		                                             <input type="datetime-local" value="${goods.goods_endtime}" class="form-control" id="goods_endtime" name="goods_endtime" placeholder="请输入结束时间">
		                                        </div>
											</c:if>

                            ...
                            <div class="card alert">
                                <div class="card-header">
                                    <div class="panel-heading bk-bg-white">
                                    	<div style="float:left;">
											<h6>
												<a type="button" class="btn btn-success m-b-10" href="shoppreSave">添加店铺</a>
			                                    <a type="button" class="btn btn-warning m-b-10" href="shoplist">刷新</a>
											</h6>
										</div>
									</div>
                                </div>
                                <div class="card-body">
                                    <table class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                        	<c:forEach varStatus="i" var="shop" items="${shoplist}">
	                                            <tr>
													<td>${i.count+(page-1)*pageSize }</td>
													<td>
														<img src="${shop.shop_images}" style="width:100px; height:60px;">
													</td>
											        <td>${shop.shop_name}</td>
											        <td>${shop.shop_opentime}</td>
											        <td>${shop.shop_iphone}</td>
											        <td>${shop.shop_addtime}</td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="shoppreSave?shopId=${shop.shop_id}">编辑</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="shopDelete('${shop.shop_id}')">删除</a>
														</div>
											        </td>
												</tr>
                                            </c:forEach>

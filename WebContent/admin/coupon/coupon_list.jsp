                            ...
                            <div class="card alert">
                                <div class="card-header">
                                    <div class="panel-heading bk-bg-white">
                                    	<div style="float:left;">
											<h6>
												<a type="button" class="btn btn-success m-b-10" href="couponpreSave">添加优惠券</a>
			                                    <a type="button" class="btn btn-warning m-b-10" href="couponlist">刷新</a>
											</h6>
										</div>
										<div class="panel-actions" style="float:right;width:430px;margin-top:10px;margin-right:15px;">
											<form name="myForm" method="post" action="couponlist">
                                ...
                                <div class="card-body">
                                    <table class="table table-responsive table-bordered">
                                        ...
                                        <tbody>
                                        	<c:forEach varStatus="i" var="coupon" items="${couponlist}">
	                                            <tr>
											        ...
											        <td>
														...
														<c:if test="${coupon.coupon_type==2}">
															 店铺优惠券
														</c:if>
													</td>
											        ...
											        <td>${coupon.coupon_endtime}</td>
													<td>
														<div style="float:left;margin-right:10px;">
															<a class="btn btn-xs btn-warning" href="couponpreSave?couponId=${coupon.coupon_id}">编辑</a>
														</div>
														<div style="float:left;">
											        		<a class="btn btn-xs btn-danger" onclick="couponDelete('${coupon.coupon_id}')">删除</a>
														</div>
											        </td>
												</tr>
                                            </c:forEach>
